...
public class GameController {
    ...
    public static boolean addedOnce;
    ...
    public void initialize(Game game) {
        ...
        this.scoreboardGui = new ScoreboardGui();
    ...
    private void addDiscardPileButton(String label) {
        ...
        button.setOnAction(e -> {
            ...
            this.selectedDiscardPileButton = button;
            this.playCard();
        });
        this.ablageStapel.getChildren().add(button);
    }
    ...
    private void playCard() {
        ...
        int stackIndex = this.ablageStapel.getChildren().indexOf(this.selectedDiscardPileButton);
    ...
    private void updateHandCards() {
        ...
        this.cardCounter.setText("Cards: " + this.game.getAllHandCardsCount(this.game.getAllHandCards())
                                                                             + " / " + this.game.getAllHandCardsMax());
    ...
    private void updateAblageStapel() {
        ...
        for (int i = 0; i < discardPiles.length; i++) {
            this.addDiscardPileButton(discardPiles[i].toString() + " " + (i+1));
        }
    }
    ...
    private void openScoreboard() {
        ...
        try {
            this.scoreboardGui.setGame(this.game);
            this.scoreboardGui.start(this.scoreboardStage);
